...
import org.processmining.Alignment.findElementsinPN;

public class RepairModel {
	@Plugin(name = "Model Repair-FL", parameterLabels = { "Petri net", "XLog" }, returnLabels = { "new pn" }, returnTypes = { Petrinet.class }, userAccessible = true, help = "This method is to repair an original model to a process model with free loop structures.")
